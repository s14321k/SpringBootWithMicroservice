...
### @MappedSuperclass
- This is going to act as the parent class for all the entities which is going to extend this class
### 

## @Column params
- `updatable = false` makes the column to be updateable and does not allows to be inserted at the initial insertion
- 
